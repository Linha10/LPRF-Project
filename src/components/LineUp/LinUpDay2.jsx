                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/2PjCxy7d085P2vQ3Nt3Vg3" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/3qsMWfRX0HPfhUBRm9uRJh" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/2UCWsnmZEVg9HhnMeKTsim" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/7A65ASxK8FMdNEFMQvRKG5" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/13topfW33NjnACjnRiZBX7" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/022DrG7Wp2PSCwzuD0bSzT" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/4Gfnly5CzMJQqkUFfoHaP3" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/7xl50xr9NDkd3i2kBbzsNZ" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="container-fluid">
                                                                <div className="row d-flex">
                                                                    ...
                                                                    <div className='socialMedia' >
                                                                        ...
                                                                        <div className=" spotify">
                                                                            <iframe src="https://open.spotify.com/embed/album/0ETFjACtuP2ADo6LFhL6HN" width="220" height="300" frameBorder="0" allowtransparency="true" allow="encrypted-media"></iframe>
                                                                        </div>
                                                                    </div>
                                                                </div>
